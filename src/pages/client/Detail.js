...
class Detail extends Component {
    ...
    render() {
        let { products, onAddToCart, cart, onCartBtnClick, onDecreaseCart, onDeleteCart, audio} = this.props
        // console.log(cart)
        ...
        return (
            <div>
                ...
                <RelateItems showProduct={this.showProduct} products={products} id={id} audio={audio}/>
            </div>
        )
    }
}
